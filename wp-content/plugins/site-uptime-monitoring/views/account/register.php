...
$nonce = wp_create_nonce('mosut-register-nonce');
echo'<!--Register with miniOrange-->
	<form name="f" method="post" action="">
		<input type="hidden" name="option" value="mo_wpns_register_customer" />
		<input type="hidden" name="mosut_register_nonce" value="'.$nonce.'" />
		<div class="mo_wpns_divided_layout">
		<div class="mo_wpns_setting_layout" style="margin-bottom:30px;">
			
				<h3>Register with miniOrange</h3>
				<p>Just complete the short registration below to configure miniOrange Site_Uptime plugin. Please enter a valid email id that you have access to.</p>
