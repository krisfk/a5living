<?php  
$forget_nonce = wp_create_nonce('mosut-forget-nonce');  
echo'
    ...
    <form id="forgot_password_form" method="post" action="">
        ...
        <input type="hidden" name="mosut_forget_nonce" value="'.$forget_nonce.'" />

    </form>
    <form id="is_from_upgrade" method="post" action="admin.php?page=moSUT_site_upgrade">
    </form>
...
$mosut_customer_selected_plan = get_option( 'mosut_customer_selected_plan' );
        if ( ! empty( $mosut_customer_selected_plan ) ) {
