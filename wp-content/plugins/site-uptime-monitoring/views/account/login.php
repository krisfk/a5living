<?php		
$login_nonce = wp_create_nonce('mosut-login-nonce');
$cancel_nonce =wp_create_nonce('mosut-cancel-nonce');

echo'	<form name="f" method="post" action="">
			<input type="hidden" name="option" value="mo_wpns_verify_customer" />
			<input type="hidden" name="mosut_login_nonce" value="'.$login_nonce.'" />
		...
		<form id="cancel_form" method="post" action="">
			...
			<input type="hidden" name="mosut_cancel_nonce" value="'.$cancel_nonce.'" />
